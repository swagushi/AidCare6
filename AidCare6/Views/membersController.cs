...
namespace AidCare6.Views
{
    public class membersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("membersId,Firstname,Lastname")] members members)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("membersId,Firstname,Lastname")] members members)
        {
