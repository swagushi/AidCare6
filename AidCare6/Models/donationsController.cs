...
namespace AidCare6.Models
{
    public class donationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("donationsID,DonationsDescription,donationsAmount,membersID")] donations donations)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("donationsID,DonationsDescription,donationsAmount,membersID")] donations donations)
        {
